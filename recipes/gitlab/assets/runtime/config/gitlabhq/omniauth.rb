Rails.application.config.middleware.use OmniAuth::Builder do
  provider :redmine, 'UUiaRVHyHGx78XzpHo1Mq2O2QpEf3WveZh4XryCA', 'EX9jk7egrckfKyUDystDwiXwwCzaeK2y3ZPSoKJj', :redmine_base_url => 'http://192.168.11.2/redmine'
end
...
OmniAuth.config.full_host = "http://192.168.11.2"
